                ...
                <div class="md:flex md:flex-shrink-0">
                    <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:flex-shrink-0 md:justify-center md:w-56">
                        <Link class="mt-1" href="/">
                            <logo class="fill-white" width="120" height="50" />
                        </Link>
                    ...
                    <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-box md:px-12 md-py-0">
                        <div class="mr-4 mt-1">
                        ...
                        <dropdown class="mt-1" placement="bottom-end">
                            <template #default>
                                <div class="group flex items-center cursor-pointer select-none">
                                    <div class="mr-1 text-gray-700 group-hover:text-indigo-600 foxus:text-indigo-600 whitespace-nowrap">
                            ...
                            <template #dropdown>
                                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                                    <Link class="block px-6 py-2 hoover:text-white hover:bg-indigo-500" :href="`/users/${auth.user.id}/edit`"> My profile </Link>
                                    <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users"> Manage User </Link>
